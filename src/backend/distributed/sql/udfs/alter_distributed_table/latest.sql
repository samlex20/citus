CREATE OR REPLACE FUNCTION pg_catalog.alter_distributed_table(
    table_name regclass, distribution_column text DEFAULT NULL, shard_count int default NULL, colocate_with text DEFAULT 'default', cascade_to_colocated boolean DEFAULT NULL)
    RETURNS VOID
    LANGUAGE C
